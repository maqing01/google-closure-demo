 ...
 */
//   Fix code/logic duplication between this and goog.ui.Control.
//   Maybe pull common stuff all the way up into Component...?
...
goog.ui.Container.prototype.getOwnerControl = function(node) {
  ...
  if (this.childElementIdMap_) {
    ...
    // using '!==' instead.
    //  Possibly revert this change if/when IE9 fixes the issue.
 ...
 */
//  Do we need to support containers with dynamic orientation?
