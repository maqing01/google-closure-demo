...
goog.require = function(name) {
  ...
  //  If we start to support require based on file name this has to
  //            change.
  //  If we allow goog.foo.* this has to change.
  //  If we implement dynamic load after page load we should probably
...
goog.getUid = function(obj) {
  //  Make the type stricter, do not accept null.
 ...
 * @private
 */
goog.UID_PROPERTY_ = 'yiqixie_uid_' + ((Math.random() * 1e9) >>> 0);
...
goog.defineClass = function(superClass, def) {
  //  consider making the superClass an optional parameter.
...
//  share these values with the goog.object
/**
...
goog.defineClass.applyProperties_ = function(target, source) {
  //  update this to support ES5 getters/setters
...
// special for soy isNonnull function
//window.isNonnull = function(arg) {
//  return !!arg;
//};

//isNonnull = goog.global.isNonnull;
