 ...
 *
 *  Remove this when all external usage is
...
goog.events.unlisten = function(src, type, listener, opt_capt, opt_handler) {
  ...
  if (!src) {
    //  We should tighten the API to only accept
...
goog.events.unlistenByKey = function(key) {
  //  Remove this check when tests that rely on this
  // are fixed.
  ...
  var listenerMap = goog.events.getListenerMap_(
      /** @type {EventTarget} */ (src));
  //  Try to remove this conditional and execute the
...
goog.events.removeAll = function(opt_obj, opt_type) {
  //  Change the type of opt_obj from Object= to
...
goog.events.getListeners = function(obj, type, capture) {
  if (goog.events.Listenable.isImplementedBy(obj)) {
    ...
    if (!obj) {
      //  We should tighten the API to accept
...
goog.events.getListener = function(src, type, listener, opt_capt, opt_handler) {
  //  Change type from ?string to string, or add assertion.
...
goog.events.fireListeners_ = function(obj, type, capture, eventObject) {
  ...
  var listenerMap = goog.events.getListenerMap_(
      /** @type {EventTarget} */ (obj));
  if (listenerMap) {
    //  Original code avoids array creation when there
...
goog.events.getUniqueId = function(identifier) {
  return identifier + '%' + goog.events.uniqueIdCounter_++;
};
