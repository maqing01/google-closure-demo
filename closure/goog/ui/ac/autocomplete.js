...
goog.ui.ac.AutoComplete = function(matcher, renderer, selectionHandler) {
   ...
   *
   *  Tighten the type to !goog.ui.ac.AutoComplete.Matcher.
   *
   * @type {Object}
   * @protected
   ...
   *
   *  Figure out what subclass does with this value
...
goog.ui.ac.AutoComplete.EventType = {
  ...
  ROW_HILITE: goog.events.getUniqueId('rowhilite'),
  ...
  HILITE: goog.events.getUniqueId('hilite'),
  ...
  CANCEL_DISMISS: goog.events.getUniqueId('canceldismiss'),
   ...
   */
  SUGGESTIONS_UPDATE: goog.events.getUniqueId('suggestionsupdate')
};
...
goog.ui.ac.AutoComplete.prototype.renderRows = function(rows, opt_options) {
  ...
  var renderOptionis = /**@type {goog.ui.ac.RenderOptions}*/ (opt_options);
  var preserveHilited =
      optionsObj ? renderOptionis.getPreserveHilited() : opt_options;
  ...
  if (optionsObj && renderOptionis.getAutoHilite() !== undefined) {
    autoHilite = renderOptionis.getAutoHilite();
  }
  this.hiliteId_ = -1;
