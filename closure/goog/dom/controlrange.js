...
//  Figure out how to unify getElements with TextRange API.
/**
...
goog.dom.ControlRange.prototype.getText = function() {
  //  What about for table selections?  Should those have text?
  return '';
};
...
goog.dom.ControlRange.prototype.removeContents = function() {
  //  Test implementing with execCommand('Delete')
  if (this.range_) {
    var nodes = [];
...
goog.dom.ControlRange.prototype.collapse = function(toAnchor) {
  //  Should this return a text range?  If so, API needs to change.
  this.range_ = null;
