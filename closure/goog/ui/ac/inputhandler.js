 ...
 *
 *  We cannot handle {Mac, Linux} x FF3 correctly.
 *  We need to support Windows x Google IME.
 *
 ...
 *    We only support SPACE-then-ENTER sequence.
 *    With the change to autocomplete during IME, this might not be an
...
goog.ui.ac.InputHandler = function(opt_separators, opt_literals,
   ...
   *
   *  Consider tuning the throttle time, so that it takes into
