 ...
 *  Key handling is flaky in Opera and Chrome
 *  Rename all references of "item" to child since menu is
...
//  Reverse constructor argument order for consistency.
/**
 * A basic menu class.
...
//  Remove this and all references to it.
...
goog.ui.Menu.prototype.getItems = function() {
  //  Remove reference to getItems and instead use getChildAt,
