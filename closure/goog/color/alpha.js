...
goog.color.alpha.hexToRgba = function(hexColor) {
  //  Enhance code sharing with goog.color, for example by
...
goog.color.alpha.rgbaToHex = function(r, g, b, a) {
  ...
  if (isNaN(intAlpha) || intAlpha < 0 || intAlpha > 255) {
    //  The CSS spec says the value should be clamped.
    throw Error('"(' + r + ',' + g + ',' + b + ',' + a +
 ...
 * @private
 */
//  Support percentages when goog.color also supports them.
