...
goog.dom.browserrange.IeRange.prototype.getEndpointNode_ = function(endpoint,
  ...
  // NOTE(skanuj) : One of the children can be the magic &nbsp; node. This
...
goog.dom.browserrange.IeRange.prototype.removeContents = function() {
  ...
  //  The htmlText check is probably unnecessary, but I left it in
  // for paranoia.
  if (!this.isCollapsed() && this.range_.htmlText) {
    ...
    // range.
    //  This condition used to happen for empty ranges, but (1)
