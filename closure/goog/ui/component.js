...
//  See if we can remove this and just check goog.i18n.bidi.IS_RTL.
/**
...
//  Stop referring to this private field in subclasses.
/**
...
/**
 * Event handler.
 *  rename it to handler_ after all component subclasses in
...
goog.ui.Component.prototype.render_ = function(opt_parentElement,
  ...
  if (!goog.userAgent.MOBILE) {
    if (!this.element_.getAttribute('data-reactid')) {
      var p1 = this.idGenerator_.getNextUniqueId();
      var p2 = this.idGenerator_.getNextUniqueId();
      var p3 = this.idGenerator_.getNextUniqueId();
      var p4 = this.idGenerator_.getNextUniqueId();
      this.element_.setAttribute('data-reactid',
          '.' + p1 + '.' + p2 + '.' + p3 + '.' + p4 + '.$=$' + goog.string.getRandomString());
    }
  }
};
...
goog.ui.Component.prototype.addChild = function(child, opt_render) {
  //  addChildAt(child, this.getChildCount(), false) will
...
goog.ui.Component.prototype.addChildAt = function(child, index, opt_render) {
  ...
  if (child.inDocument_ && this.inDocument_ && child.getParent() == this) {
    ...
    //  We should have a renderer with a renderChildAt API.
    ...
    //  It would be nice to move this condition entirely, but
