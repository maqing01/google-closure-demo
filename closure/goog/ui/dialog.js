...
goog.ui.Dialog.prototype.draggable_ = false;
 ...
 *  Deprecate in favor of setSafeHtmlContent, once developer docs on
...
goog.ui.Dialog.prototype.renderIfNoDom_ = function() {
  if (!this.getElement()) {
    //  Ideally we'd only create the DOM, but many applications
...
goog.ui.Dialog.prototype.createDom = function() {
  ...
  this.titleEl_ = dom.createDom('div', goog.getCssName(this.class_, 'title'),
      ...
      this.titleCloseEl_ = dom.createDom(
          ...
          + goog.getCssName('yiqixie-agra-icon') + ' ' + goog.getCssName('icon-agra-close')));
...
goog.ui.Dialog.prototype.decorateInternal = function(element) {
  ...
  if (!this.titleCloseEl_) {
    this.titleCloseEl_ = this.getDomHelper().createDom('span',
        titleCloseClass + ' ' + goog.getCssName('icon-agra-close')
        + ' ' + goog.getCssName('yiqixie-agra-icon'));
 ...
 *  Change this to goog.ui.Dialog.EventType.SELECT.
 * @type {string}
...
goog.ui.Dialog.ButtonSet = function(opt_domHelper) {
  //   Refactor ButtonSet to extend goog.ui.Component?
...
goog.ui.Dialog.ButtonSet.prototype.render = function() {
  if (this.element_) {
    ...
    this.forEach(function(caption, key) {
      var buttonSpan = domHelper.createDom('span', goog.getCssName('button-text'),
          caption);
      var button = domHelper.createDom('div', {'name': key}, buttonSpan);
 ...
 *   ButtonSet should be a goog.ui.Component.  Really.
...
goog.ui.Dialog.ButtonSet.prototype.decorate = function(element) {
  ...
  var buttons = this.element_.getElementsByTagName('div');
 ...
 *  Remove after refactoring to goog.ui.Component.
 */
...
goog.ui.Dialog.ButtonSet.prototype.getAllButtons = function() {
  return this.element_.getElementsByTagName(goog.dom.TagName.DIV);
};
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_OK_ = goog.getMsg('OK(yiqixie)');
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_CANCEL_ = goog.getMsg('Cancel(yiqixie)');
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_YES_ = goog.getMsg('Yes(yiqixie)');
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_NO_ = goog.getMsg('No(yiqixie)');
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_SAVE_ = goog.getMsg('Save(yiqixie)');
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_CONTINUE_ = goog.getMsg('Continue(yiqixie)');
 ...
 * @private
 */
goog.ui.Dialog.MSG_GOOG_UI_DIALOG_CLOSE_ = goog.getMsg('Close(yiqixie)');
...
//  These shared instances should be phased out.
(function() {
