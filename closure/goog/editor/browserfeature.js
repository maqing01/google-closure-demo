...
goog.editor.BrowserFeature = {
  ...
  //  Enable for all FF3 once we're confident this event fires
  ...
  // but width=99% does.
  //  This should be fixable by less hacky means
  ...
  //  Link to public documentation of this feature if Opera puts
